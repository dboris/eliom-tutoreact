...
let%shared select_language_form =
  (fun select_language_name ->
     let open Eliom_content.Html in
     let current_language = Tutoreact_i18n.get_language () in
     let all_languages_except_current =
       List.filter
         (fun l -> l <> current_language)
         Tutoreact_i18n.languages
     in
     let form_option_of_language language is_current_language =
       D.Form.Option (
         [], (* No attributes *)
         Tutoreact_i18n.string_of_language language,
         None,
         is_current_language
       )
     in
    ...
    [
      div ~a:[a_class ["os-settings"]] [
        ...
        Os_user_view.upload_pic_link
          ...
          Tutoreact_services.upload_user_avatar_service;
        br ();
