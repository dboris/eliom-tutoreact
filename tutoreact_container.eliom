  ...
  Lwt.return (
    header ~a:[a_class ["os-page-header"]]
      [ a ~a:[a_class ["os-page-header-app-name"]]
          ...
          [ txt Tutoreact_base.displayed_app_name ]
          ()
      ; user_box
      ]
  )
...
let%shared os_footer () = Eliom_content.Html.F.(
  footer ~a:[a_class ["os-page-footer"]] [
    p [
      ...
      a ~service:Tutoreact_services.os_github_service
        [ txt " Ocsigen Start " ] ();
      txt [%i18n S.footer_eliom_distillery];
      a ~service:Tutoreact_services.ocsigen_service
        [ txt " Ocsigen " ] ();
